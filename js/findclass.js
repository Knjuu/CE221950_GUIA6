function iniciar() {
    ...
    if (btnfind.addEventListener) {
        btnfind.addEventListener("click", function () {
            // Se supone que el valor del campo de texto y del campo select del formulario
            // estará establecido cuando se haga clic en el botón Encontrar
...
function findClassInElements(className, type) {
    ...
    // Puede ser un elemento en particular o todos los elementos
    var elems = document.getElementsByTagName(type || "*");
    // En este caso, el patrón de la expresión regular incluirá una variable,
    // por lo tanto, estará obligado a usar el constructor RegExp.
